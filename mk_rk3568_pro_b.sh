...
# 20201212 add
BAL_CONFIG="${PWD}/files/rk3568/pro-rk3568-b/balance_irq"
...
BOOTFILES_HOME="${PWD}/files/bootfiles/rockchip/rk3568/pro-rk3568-b"
GET_RANDOM_MAC="${PWD}/files/get_random_mac.sh"
BOOTLOADER_IMG="${PWD}/files/rk3568/pro-rk3568-b/bootloader.bin"
...
# 20220927 add
BOARD_HOME="${PWD}/files/rk3568/pro-rk3568-b/board.d"
# 20221001 add
MODULES_HOME="${PWD}/files/rk3568/modules.d"
# 20221123 add
BOARD_MODULES_HOME="${PWD}/files/rk3568/pro-rk3568-b/modules.d"
# 20221013 add
WIRELESS_CONFIG="${PWD}/files/rk3568/pro-rk3568-b/wireless"
# 20230622 add
#NETWORK_SERVICE_PATCH="${PWD}/files/rk3568/pro-rk3568-b/network.patch"

# 20230921 add
#DC_VOLTAGE_PATCH="${PWD}/files/rk3568/pro-rk3568-b/dc_voltage.patch"
####################################################################
